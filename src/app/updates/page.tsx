...
export default function UpdatesPage() {
  ...
  return (
    <>
      ...
      {/* Featured — most recent across every stream */}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10" data-reveal>
          ...
          >
            <div className="relative min-h-64 overflow-hidden">
              <Image
                src={getInsightImage(lead.topic)}
                alt=""
                fill
            ...
            <div className="p-8 lg:p-12">
              <div className="flex flex-wrap items-center gap-3 text-xs">
                ...
                <span className="text-muted/50">Latest &middot; {lead.category}</span>
              </div>
      ...
      {insightCategories.map((category) => {
        const items = insightsByCategory(category).slice(0, 3);
